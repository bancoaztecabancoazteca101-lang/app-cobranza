...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun comisionDao(): ComisionDao
    abstract fun bolsaGerenciaDao(): BolsaGerenciaDao
    ...
    companion object {
        ...
        private val MIGRATION_27_28 = object : Migration(27, 28) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Nueva tabla para el reporte "Comisión" (submenú de Control) -- captura manual,
                // mismo patrón de fila única que velocidad_table.
                db.execSQL("""CREATE TABLE IF NOT EXISTS comision_table (id INTEGER NOT NULL PRIMARY KEY, momento12 REAL NOT NULL, indirecta12 REAL NOT NULL, momento3 REAL NOT NULL, indirecta3 REAL NOT NULL, momento46 REAL NOT NULL, indirecta46 REAL NOT NULL, momento79 REAL NOT NULL, indirecta79 REAL NOT NULL, meta REAL NOT NULL, lastUpdate INTEGER NOT NULL)""")
            }
        }
        private val MIGRATION_28_29 = object : Migration(28, 29) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Nueva tabla para el reporte "Bolsa Gerencia" (4to submenú de Control) --
                // captura manual, mismo patrón de fila única que comision_table.
        ...
        private val MIGRATION_30_31 = object : Migration(30, 31) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Ref 3, Ref 4, Día de pago y Domicilio Laboral: campos 100% locales de Matriz
                // (no existen en el Sheet, la hoja "Matriz " no se toca).
                db.execSQL("ALTER TABLE matriz_table ADD COLUMN ref3 TEXT")
                db.execSQL("ALTER TABLE matriz_table ADD COLUMN ref4 TEXT")
                db.execSQL("ALTER TABLE matriz_table ADD COLUMN diaPago TEXT")
                db.execSQL("ALTER TABLE matriz_table ADD COLUMN domicilioLaboral TEXT")
            }
        }
